...
//            R.drawable.ic_seek_thumb_disabled);
    ...
    private final float thumbWidth = thumbRadius*2;
    private final float thumbHalfWidth = 0.5f * thumbWidth;
    private final float thumbHalfHeight = thumbRadius;
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        paint.setColor(getContext().getResources().getColor(R.color.darkTextColor));
        ...
        paint.setColor(getContext().getResources().getColor(R.color.rangeSeekBarBackgroundLineColor));
...
//        paint.setColor(colorToUseForButtonsAndHighlightedLine);
        paint.setColor(getContext().getResources().getColor(R.color.rangeSeekBarActiveRangeLineColor));
        canvas.drawRect(mRect, paint);
...
//        }
    ...
    private void drawThumb(float screenCoord, boolean pressed, Canvas canvas, boolean areSelectedValuesDefault) {
        if (areSelectedValuesDefault) {
            drawDisabledThumb(canvas, screenCoord, mTextOffset+thumbHalfHeight, thumbRadius);
        } else if(pressed){
            drawPressedThumb(canvas, screenCoord, mTextOffset+thumbHalfHeight, thumbRadius);
        } else {
            drawNormalThumb(canvas, screenCoord, mTextOffset+thumbHalfHeight, thumbRadius);
        }
    }

    private void drawNormalThumb(Canvas canvas, float xCoord, float yCoord, float radius) {
        paint.setColor(getContext().getResources().getColor(R.color.rangeSeekBarThumbNormalBackground));
        canvas.drawCircle(xCoord, yCoord, radius, paint);

        paint.setColor(getContext().getResources().getColor(R.color.rangeSeekBarThumbCenterColor));
        canvas.drawCircle(xCoord, yCoord, radius/5, paint);

    }

    private void drawPressedThumb(Canvas canvas, float xCoord, float yCoord, float radius) {
    ...
    private void drawDisabledThumb(Canvas canvas, float xCoord, float yCoord, float radius) {

        paint.setColor(getContext().getResources().getColor(R.color.rangeSeekBarThumbDisabledBackground));
        canvas.drawCircle(xCoord, yCoord, radius, paint);
